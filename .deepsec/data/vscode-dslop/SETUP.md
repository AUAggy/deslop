# Agent setup for `vscode-dslop`

This is a deepsec scanning workspace. Project `vscode-dslop` was just registered
(target: `..`). Setup is incomplete — `data/vscode-dslop/INFO.md`
...
2. **Fill in `data/vscode-dslop/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id vscode-dslop
pnpm deepsec process --project-id vscode-dslop
```
